...
def _register_analysis_artifacts(
    ...
    *,
    ...
    candidates = [
        ...
        (ArtifactType.DEBUG_JSON.value, workspace.pitch_contours_path, "application/json"),
        (ArtifactType.NOTE_CANDIDATES.value, workspace.note_candidates_path, "application/json"),
        (ArtifactType.DEBUG_JSON.value, workspace.selected_melody_path, "application/json"),
        (ArtifactType.DEBUG_JSON.value, workspace.quantized_notes_path, "application/json"),
